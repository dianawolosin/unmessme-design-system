...
### 4.3 Brand Taglines & Hooks
- **Primary Tagline:** "Your life. But organized. Finally."
...
## 8. UI Microcopy Standards
### 8.1 Interactive Elements (Buttons, Links, Menu Items)
- **Casing**: Title Case for all interactive text (e.g., "View Dashboard", "Add New", "Read More").
- **Style**: Direct, active verbs.
- **Length**: Keep it short (1-3 words max).

### 8.2 System Status Messages
- **Style**: Monospace, technical, pseudo-code style.
- **Format**: `// STATUS: [STATE] -> [ACTION]`
- **Usage**: Use sparingly for transitional states or "loading" humor.

---

## 9. Metadata for MCP (Tone Flags)
...
- enforce Title Case for all interactive elements (buttons, links, menus)
